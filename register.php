...
if (isset($_REQUEST['name']) && isset($_REQUEST['age']) && isset($_REQUEST['address']) && isset($_REQUEST['phone']) && isset($_REQUEST['employment']) && isset($_REQUEST['email']) && isset($_REQUEST['password'])) {
    // Lấy giá trị từ form
    $name = $_REQUEST['name'];
    $age = $_REQUEST['age'];
...
<?php else : ?>
    <form method="post" action="">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="employment" id="employment" required>
        </div>
        <div class="mb-3">
